...
function PdfRotate({ lang = 'en' }: Props) {
  ...
  const rotatePdf = async () => {
    ...
    try {
      ...
      download(blob, `rotated-${safeName}`);
    } catch (error) {
      console.error(error);
      ...
      <div className="max-w-md mx-auto text-center space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button 
            ...
            className="p-4 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-zinc-100 dark:bg-zinc-800 dark:hover:bg-zinc-800 transition-all"
          >
